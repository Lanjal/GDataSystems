...
from .ajusta_solo_dialog import AjustaSoloDialog
import os.path
...
class AjustaSolo:
    ...
    def tr(self, message):
        return QCoreApplication.translate('AjustaSolo', message)
    ...
    def initGui(self):
        icon_path = ':/plugins/ajusta_solo/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'GDS-Ajustar Campos de Solo'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            if self.dlg.checkBoxCsv.isChecked():
                ...
                QgsVectorFileWriter.writeAsVectorFormat(result,os.path.join(csv,"dadossolo.csv"),"utf-8",driverName = "CSV")
